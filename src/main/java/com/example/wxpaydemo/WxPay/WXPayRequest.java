...
import static com.qianyuan.WxPay.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    public String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs,
